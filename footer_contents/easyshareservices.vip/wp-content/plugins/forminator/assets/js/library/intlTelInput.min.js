        ...
        var H = (l, t) => {
            ...
            O = (l, t, e, i) => {
                if (t && typeof t == "object" || typeof t == "function")
                    for (let n of x(t)) !P.call(l, n) && n !== e && I(l, n, {
                        get: () => t[n],
            ...
            _ = class {
                ...
                _f() {
                    ...
                    if (this.a.parentNode ? .insertBefore(p, this.a), t || i) {
                        this.k = c("div", {
                        ...
                        }, p), t ? (this.selectedCountry = c("button", {
                            type: "button",
                            ...
                            role: "combobox"
                        }, this.k), this.a.disabled && this.selectedCountry.setAttribute("disabled", "true")) : this.selectedCountry = c("div", {
                            class: "iti__selected-country"
                        }, this.k);
                        let m = c("div", {
                            class: "iti__selected-country-primary"
                        }, this.selectedCountry);
                        if (this.l = c("div", null, m), this.selectedCountryA11yText = c("span", {
                                class: "iti__a11y-text"
                            }, this.l), t && (this.u = c("div", {
                                class: "iti__arrow",
                                "aria-hidden": "true"
                            }, m)), e && (this.t = c("div", {
                            ...
                            if (this.dropdownContent = c("div", {
                                    ...
                                    autocomplete: "off"
                                }, this.dropdownContent), this.searchResultsA11yText = c("span", {
                                    class: "iti__a11y-text"
                                }, this.dropdownContent)), this.countryList = c("ul", {
                                ...
                                u ? y += " iti--fullscreen-popup" : y += " iti--inline-dropdown", this.dropdown = c("div", {
                                    class: y
                    ...
                    if (p.appendChild(this.a), s) {
                        ...
                        C.phone && (this.hiddenInput = c("input", {
                            type: "hidden",
                            name: C.phone
                        }), p.appendChild(this.hiddenInput)), C.country && (this.hiddenInputCountry = c("input", {
                            type: "hidden",
                            name: C.country
