    ...
    function(l, f, a) {
        ...
        l.extend(e.prototype, {
            ...
            maybe_append_scripts: function(t) {
                ...
                for (e in t)
                    if (t.hasOwnProperty(e)) {
                        ...
                        i = {};
                        i.src = t[e].src, i.async = t[e].async ? ? !0, i.src !== o && (r.push(i), this.scriptsQue.push(e))
                    }
            ...
            load_script: function(t) {
                ...
                r.type = "text/javascript", r.src = t.src, r.async = t.async, r.defer = !0, r.onload = function() {
                    e.script_on_load()
    ...
    function(l, f, s) {
        ...
        l.extend(e.prototype, {
            ...
            init_intlTelInput_validation: function(t) {
                ...
                a.find(".forminator-field--phone").each(function() {
                    ...
                    void 0 !== n && (n = {
                        ...
                        strictMode: !0
                    }, void 0 !== i && "standard" === i && (n.allowDropdown = !1), void 0 !== i && "international" === i && (n.autoHideDialCode = !1), t = f.intlTelInput(r, n), void 0 !== i && "international" === i && (e = "+" + (n = t.getSelectedCountryData().dialCode)) !== l(this).val() && (n = l(this).val().trim().replace(n, "").replace("+", ""), l(this).val(e + n)), void 0 !== i && "standard" === i && l(this).on("blur", function() {
                        "" === l(r).val() && (t.setCountry(o), a.validate().element(l(r)))
            ...
            a.on("change", function() {
                ...
                var e, r, n, o = a.id,
                    o = l("#" + o).closest(".forminator-col").find(".forminator-description span"),
                    i = a.getContent().replace(/<[^>]*>/g, "");
                o.length && o.data("limit") && (i = l("<div/>").html(i).text(), e = o.data("limit"), r = t.ctrlKey || t.metaKey, n = -1 !== [37, 38, 39, 40, 8, 46].indexOf(t.keyCode), "words" !== o.data("type") ? i.length >= e && !r && !n && 13 !== t.keyCode && t.preventDefault() : e <= i.trim().split(/\s+/).length && 32 === t.which && t.preventDefault())
            }), l("#" + a.id + "_ifr").is(":visible") && l("#" + a.id + "_ifr").height(l("#" + a.id).height()), -1 !== e.indexOf("forminator") && l("#" + e).closest(".wp-editor-wrap").attr("aria-describedby", e + "-description")
...
function(f, l, r) {
    ...
    function e(t, e) {
        this.element = f(t), this.$el = this.element, this.totalSteps = 0, this.step = 0, this.finished = !1, this.hashStep = !1, this.next_button_txt = "", this.prev_button_txt = "", this.custom_label = [], this.form_id = 0, this.element = "", this.settings = f.extend({}, o, e), this._defaults = o, this._name = n, this.init()
    }
        ...
        render_navigation: function() {
            ...
            if (o.length) {
                ...
                var i = this.$el.find(".forminator-pagination").not(".forminator-pagination-start"),
                    ...
                    s = (o.append('<div class="forminator-break"></div>'), this);
                i.each(function() {
                    var t = f(this),
            ...
            "vertical" !== r.layout && (t.tagline = r.tagline), this.paypalButton = paypal.Buttons({
                ...
                onClick: function() {
                    if (!i.valid() && r.amount <= 0) n.removeClass("forminator-accessible").addClass("forminator-error").html("").removeAttr("aria-hidden"), n.html('<label class="forminator-label--error"><span>' + o.payment_require_amount_error + "</span></label>"), a.focus_to_element(n);
                        ...
                        if (i.trigger("forminator:preSubmit:paypal", [n]), n.find(".forminator-invalid-captcha").html()) return a.focus_to_element(n), !1
...
function(m) {
    ...
    m.extend(e.prototype, {
        ...
        return t = i(t, e), this.optional(e) || t.trim().split(/\s+/).length <= r
    ...
    b.extend(e.prototype, {
                ...
                if (!c.$el.find(".forminator-button-submit").prop("disabled"))
                    if (c.disable_form_submit(c, !0), 0 !== c.$el.find('input[type="hidden"][value="forminator_submit_preview_form_custom-forms"]').length) c.disable_form_submit(c, !1);
                        ...
                        if (o.originalEvent !== g) {
                            ...
                            if (0 === u.length || b(u).closest(".forminator-col").hasClass("forminator-hidden")) return c.disable_form_submit(c, !1), !1
                        }
                        0 !== a.length && c.$el.datepicker("widget").is(":visible") ? c.disable_form_submit(c, !1) : c.$el.data("forminatorFrontPayment") && !i && (s.find(".forminator-button-submit").attr("disabled", !0), !1 === c.processCaptcha(c, r, f, n)) ? (s.find(".forminator-button-submit").attr("disabled", !1), c.disable_form_submit(c, !1)) : (c.multi_upload_disable(s, !0), t = function() {
                            var t = c.$el.find(".forminator-pagination:visible"),
                                e = !!t.length,
                                t = t.index(".forminator-pagination");
                            if (l = new FormData(this), i && e && l.append("draft_page", t), !c.$el.data("forminatorFrontPayment") && !i && !1 === c.processCaptcha(c, r, f, n)) return c.disable_form_submit(c, !1), !1;
                            c.$el.hasClass("forminator_ajax") || i ? (f.html(""), c.$el.find(".forminator-button-submit").addClass("forminator-button-onload"), c.$el.find("input[type=file]").each(function() {
                            ...
                            }), void 0 !== c.settings.has_loader && c.settings.has_loader && ("login" !== c.$el.find('input[name="form_type"]').val() && c.$el.addClass("forminator-fields-disabled"), f.html("<p>" + c.settings.loader_label + "</p>"), c.focus_to_element(f), f.removeAttr("aria-hidden").prop("tabindex", "-1").removeClass("forminator-success forminator-error forminator-accessible").addClass("forminator-loading forminator-show")), r.preventDefault(), b.ajax({
                                type: "POST",
                                ...
                                success: function(t) {
                                    ...
                                    }), s.find(".forminator-button-delete").hide(), s.find(".forminator-file-upload input").val(""), s.find(".forminator-file-upload > span").html(y.ForminatorFront.cform.no_file_chosen), s.find("ul.forminator-uploaded-files").html(""), c.$el.find("ul.forminator-uploaded-files").html(""), c.$el.find(".forminator-multifile-hidden").val(""), 0 < s.find(".forminator-select").length && s.find(".forminator-select").each(function(t, e) {
                        ...
                        }, u = c.$el.find('div[data-is-payment="true"]').closest(".forminator-row, .forminator-col").hasClass("forminator-hidden"), !c.$el.data("forminatorFrontPayment") || u || i ? t.apply(e) : setTimeout(function() {
        ...
        sendDraftLink: function(t) {
            ...
            b("body").on("submit", t, function(t) {
                ...
                r.addClass("submitting"), i.attr("disabled", !0), r.removeClass("forminator-has_error"), o.removeClass("forminator-has_error"), o.find(".forminator-error-message").remove(), t.preventDefault(), b.ajax({
                    type: "POST",
                    url: y.ForminatorFront.ajaxUrl,
                    data: e,
                    cache: !1,
                    ...
                    success: function(t) {
                        var e = t.data;
                        if (!t && void 0 !== t || "object" != typeof e) return i.removeAttr("disabled"), a.addClass("forminator-error").html("<p>" + y.ForminatorFront.cform.error + "<br>(" + e + ")</p>"), l.focus_to_element(a), !1;
                        t.success || g === e.field || "email-1" !== e.field || o.hasClass("forminator-has_error") || (r.addClass("forminator-has_error"), o.addClass("forminator-has_error"), o.append('<span class="forminator-error-message" aria-hidden="true">' + e.message + "</span>")), t.success && (e.draft_mail_sent ? s.removeClass("draft-error").addClass("draft-success") : s.removeClass("draft-success").addClass("draft-error"), s.html(e.draft_mail_message), s.show(), r.hide())
                    },
                    error: function(t) {
        ...
        processCaptcha: function(t, e, r, n) {
            if ((o = t.$el.find(".forminator-g-recaptcha, .forminator-hcaptcha")).length) {
                var o, i = (o = b(o.get(0))).data("size"),
                    a = o.parent(".forminator-col");
                if (o.hasClass("forminator-g-recaptcha")) {
                    var s = o.data("forminator-recapchta-widget");
                    if (("normal" === i || "compact" === i) && "onSubmitAuthenticationBox" === n) return;
                    if (0 !== o.children().length) {
                        var l = y.grecaptcha.getResponse(s);
                        if ("invisible" === i && "forminator:preSubmit:paypal" === e.type) return;
                        if ("invisible" === i && 0 === l.length) return y.grecaptcha.execute(s), !1;
            ...
            b("body").on("submit.frontSubmit", this.settings.forminator_selector, function(t) {
                if (0 === m.$el.find('input[type="hidden"][value="forminator_submit_preview_form_quizzes"]').length) {
                    var e, r = b(this),
                        ...
                        i = m.$el.find(".forminator-button").last(),
                    ...
                    "" !== s && i.text(s), m.settings.has_quiz_loader && o.each(function() {
                        var t = b(this),
                            e = t.find("input"),
                    ...
                    b.ajax({
                        ...
                        success: function(u) {
                            ...
                            u.success ? (t = "", a.removeClass("forminator-hidden"), y.history.pushState("forminator", "Forminator", u.data.result_url), "nowrong" === u.data.type ? (t = u.data.result, a.html(t), d || m.$el.find(".forminator-answer input").attr("disabled", "disabled")) : "knowledge" === u.data.type && (t = u.data.finalText, 0 < a.length && a.html(t), Object.keys(u.data.result).forEach(function(t) {
                                ...
                                if (n.text(u.data.result[t].message), n.addClass("forminator-show"), o.attr("disabled", !0), o.attr("aria-disabled", !0), i.attr("disabled", !0), i.attr("aria-disabled", !0), g === u.data.result[t].answer)
        ...
        handle_submit_poll: function() {
            ...
            u.$el.find(".forminator-response-message").not(":hidden").length && u.focus_to_element(u.$el.find(".forminator-response-message"), !0), b("body").on("submit.frontSubmit", this.settings.forminator_selector, function(t) {
                var r, n, o, i, a, s;
                return 0 === u.$el.find('input[type="hidden"][value="forminator_submit_preview_form_poll"]').length && (r = b(this), n = new FormData(this), o = r.serialize(), i = u.$el.find(".forminator-response-message"), a = u.$el.find("fieldset"), s = u.$el.find(".forminator-button"), !u.$el.hasClass("forminator_ajax") || (l(), b.ajax({
                    type: "POST",
                    url: y.ForminatorFront.ajaxUrl,
                    data: o,
                    beforeSend: function() {
        ...
        render_poll_chart: function(t, e, r, n, o) {
            ...
            a = r.$el.find(".forminator-chart-wrapper"), i = r.$el.find(".forminator-chart"), a.remove(), i.remove(), a = b('<canvas id="' + s + '" class="forminator-chart" role="img" aria-hidden="true"></canvas>'), l.append(a), FUI.pollChart("#" + s, t, r.settings.chart_design, o), (i = l.find(".forminator-field")).hide(), i.attr("aria-hidden", "true"), a = r.$el.find(".forminator-chart"), ((s = r.$el.find(".forminator-chart-wrapper")).length ? (a.addClass("forminator-show"), s.addClass("forminator-show"), s.removeAttr("aria-hidden"), s.attr("tabindex", "-1"), s) : (a.html("<p>Fallback text...</p>"), a.addClass("forminator-show"), a.removeAttr("aria-hidden"), a.attr("tabindex", "-1"), a)).focus(), t = b(e), f.empty(), f.append(t), r.$el.find(".forminator-button").click(function(t) {
        ...
        focus_to_element: function(t, e, r, n) {
            ...
            0 < t.closest(".sui-dialog").length && (o = ".sui-dialog"), 0 < t.closest(".wph-modal").length && (o = ".wph-modal"), t.hasClass("forminator-textarea") || t.parent(".wp-editor-container").length ? t.hasClass("forminator-textarea") && t.parent(".wp-editor-container").length && (t = t.parent(".wp-editor-container")) : t.show(), e ? i(t) : b(o).animate({
