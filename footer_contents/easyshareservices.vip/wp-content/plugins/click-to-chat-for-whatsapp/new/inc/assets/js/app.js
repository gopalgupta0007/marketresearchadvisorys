! function(t) {
    t((function() {
        ...
        if ("no" == n) n = void 0 !== screen.width && screen.width > 1025 ? "no" : "yes";
        var a = "",
            _ = {};
                ...
                window.open(h, d, l), s.chat_number = o,
                    function() {
                        ...
                        if (s.ga) {
                            ...
                            r = t(r), u.g_an_params && u.g_an_params.forEach((e => {
                                if (u[e]) {
                                    var c = u[e],
                                        n = c.key,
                                        _ = c.value;
                            ...
                            if ("undefined" != typeof dataLayer) try {
                                ...
                                function g(t) {
                                    t = t.toUpperCase(), l.includes(t) || (l.push(t), (t.startsWith("G-") || t.startsWith("GT-")) && (a.send_to = t, gtag("event", r, a), h++))
                                }
                                if (window.google_tag_data && window.google_tag_data.tidr && window.google_tag_data.tidr.destination)
                                    for (var p in window.google_tag_data.tidr.destination) g(p);
                                dataLayer.forEach((function(t) {
                                    "config" == t[0] && t[1] && g(p = t[1])
                                }))
                            } catch (y) {}
                        ...
                        if ("undefined" != typeof dataLayer && dataLayer.push({
                            ...
                            var m = s.pixel_event_name && "" !== s.pixel_event_name ? s.pixel_event_name : "Click to Chat by HoliThemes",
                                v = u.pixel_event_type && "" !== u.pixel_event_type ? u.pixel_event_type : "trackCustom",
                                f = {};
                            u.pixel_params && u.pixel_params.forEach((e => {
                                if (u[e]) {
                                    var c = u[e],
                                        n = c.key,
                                        a = c.value;
